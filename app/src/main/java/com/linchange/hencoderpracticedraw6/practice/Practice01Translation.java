package com.linchange.hencoderpracticedraw6.practice;
...
import com.linchange.hencoderpracticedraw6.R;
import com.linchange.hencoderpracticedraw6.Utils;

import static android.os.Build.VERSION.SDK_INT;
import static com.linchange.hencoderpracticedraw6.Utils.dpToPixel;
...
public class Practice01Translation extends RelativeLayout {
    ...
    int clickTimes = 0;
    int totalTimes = Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP ? 6 : 4;
                ...
                switch (clickTimes) {
                    ...
                    case 4:
                        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
                            imageView.animate().translationZ(Utils.dpToPixel(30));
                        }
                        break;
                    case 5:
                        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
